...
ConvState.prototype.printQuestion = function(){
    ...
    setTimeout(function(){
        ...
        let profileChatbotDiv = document.createElement('div');
        profileChatbotDiv.className = 'profile-chatbot client_logoDiv';
        profileChatbotDiv.innerHTML = user_image;
        
        messageObj[0].append(profileChatbotDiv);
...
ConvState.prototype.answerWith = function(answerText, answerObject) {
    ...
    if(this.current.input.type == 'password')
        ...
        profileUserDiv.className = 'user-chatbot client_logoDiv';
        profileUserDiv.innerHTML = candidate_image;
        
        message[0].append(profileUserDiv);
