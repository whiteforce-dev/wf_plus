...
<a href="{{ url('https://white-force.com/plus/tutorial/#addhrdiv') }}" target="_blank">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('hr.store') }}" method="post" id="addHr"enctype="multipart/form-data">
                                    @csrf
                                    <div class="mb-3 row">
                                        <label class="col-sm-2 col-form-label  c ">Client Name</label>
                                        <div class="col-sm-6">
                                            <select class="default-select form-control wide single-select" name="client_name" placeholder="Select client name">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-6">
                                            <input type="text" class="form-control" placeholder="Hr Name"
                                            name="hr_name">
                                        </div>
                                    </div>
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="text" class="form-control" placeholder="Hr Email"
                                                name="hr_email">
                                            </div>
                                        </div>

                                        <div class="mb-3 row">
                                            <label class="col-form-label col-sm-2 pt-0 c ">DOB <br> <small style="font-size: 8px;">(For Birthday mail)</small></label>
                                            <div class="col-sm-6">
                                   ...
                                   <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-6">
                                                <input type="number" class="form-control" placeholder="Hr Mobile"
                                                name="hr_mobile">
                                            </div>
                                    </div>
                                    <div class="mb-3 row">
                                    ...
                                    <div class="mb-3 row">
                                        ...
                                        <div class="col-sm-6">
                                            <button class="btn btn-primary col-12 btn-block" type="submit">Add HR</button>
                                        </div>
                                    </div>
