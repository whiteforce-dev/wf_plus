...
<head>
	...
	<link rel="stylesheet" type="text/css" href="{{ url('assets/candidateRevertAssets/jquery.convform.css') }}">
	<link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css" integrity="sha384-BVYiiSIFeK1dGmJRAkycuHAHRg32OmUcww7on3RYdg4Va+PmSTsz/K68vbdEjh4u" crossorigin="anonymous">
	<link rel="stylesheet" type="text/css" href="{{ url('assets/candidateRevertAssets/demo.css') }}">
	<link rel="stylesheet" type="text/css" href="{{ url('assets/candidateRevertAssets/style.css') }}">
	<link rel="shortcut icon" href="https://white-force.com/mail_assets/whiteforcelogo.png" type="image/x-icon">
   
</head>
<body>
	<div class="logo_desktop">
        <img src="{{ url('assets/candidateRevertAssets/white-force-logo29-06.png') }}" alt="">
    </div>
	...
	<section class="forms-container">
		...
		<div id="chat" class="conv-form-wrapper">
			<form action="{{ url('candidate_revert_submit') }}" method="post" class="hidden" style="top:-58px; bottom: 36px;" id="submit_form">
                
                <!--introduction-->
                <input type="text" data-conv-question="Hello, I am Sophia!! Congratulations!! 🎉🎉🎉 {{ !empty($candidate_data->candidate->name) ? ucwords(strtolower($candidate_data->candidate->name)) : ''}},  Your profile has been shortlisted." data-no-answer="true">
                ...
                <div data-conv-fork="is_exp">
                    <div data-conv-case="yes">
                       ...
                       <select data-conv-question="How much experience you have?" name="exp_year" id="exp_year">
                            ...
                            <option value="35+">25+ Years</option>
                        </select>
                ...
                <div data-conv-fork="mobile_confirm">
                    <div data-conv-case="no">
                        <input type="number" data-conv-question="Please add correct mobile number" name="correct_mobile" id="correct_mobile">
                    </div>
                </div>
                ...
                <div data-conv-fork="email_confirm">
                    <div data-conv-case="no">
                        <input type="number" data-conv-question="Please add correct email" name="correct_email" id="correct_email">
                    </div>
                </div>
	...
	<script type="text/javascript" src="{{ url('assets/candidateRevertAssets/jquery-1.12.3.min.js') }}"></script>
	<script type="text/javascript" src="{{ url('assets/candidateRevertAssets/autosize.min.js') }}"></script>
	<script type="text/javascript" src="{{ url('assets/candidateRevertAssets/jquery.convform.js') }}"></script>
