  ...
  <body>
    ...
    <section class="video" id="home">
      <div class="video-foreground">
        <iframe
          ...
          height="100%"
          width="100%"
          src="https://www.youtube.com/embed/HaOTTmmY39w?autoplay=1&amp;controls=0&amp;mute=1&amp;rel=0&amp;cc_load_policy=3&amp;loop=1&amp;enablejsapi=1"
    ...
    <section class="about" style="margin-top: -130px !important" id="data-para">
      <div class="real">
        ...
        <div class="paragraph">
          <p>
            Sushma Group is a dynamic and rapidly growing Real Estate
    ...
    <section class="container pb-5 mb-2 mb-md-4 mb-lg-5 mt-n2">
      ...
      <div class="gallery row g-4" data-video="true" data-thumbnails="true">
        <div class="col-md-5">
          ...
          >
            <img
            src="{{ asset('integrations/home-image/assets/img/about/gallery/01.jpg') }}"
        ...
        <div class="col-md-3 col-sm-5">
          <a
            href="{{ asset('integrations/home-image/assets/img/about/gallery/02.jpg') }}"
            class="gallery-item rounded-3 mb-4"
            data-sub-html='<h6 class="fs-sm text-light">Program for apprentices</h6>'
            target="_blank"
          >
            <img
              src=" {{ asset('integrations/home-image/assets/img/about/gallery/02.jpg') }}"
              alt="Gallery thumbnail"
            />
          ...
          <a
            href="{{ asset('integrations/home-image/assets/img/about/gallery/03.jpg') }}"
            class="gallery-item rounded-3"
            data-sub-html='<h6 class="fs-sm text-light">Modern bright offices</h6>'
            target="_blank"
          >
            <img
              src= "{{ asset('integrations/home-image/assets/img/about/gallery/03.jpg') }}"
              alt="Gallery thumbnail"
            />
        ...
        <div class="col-md-4 col-sm-7">
          <a
            href="{{ asset('integrations/home-image/assets/img/about/gallery/04.jpg') }}"
          ...
          >
            <img
            src= "{{ asset('integrations/home-image/assets/img/about/gallery/04.jpg') }}"
              alt="Gallery thumbnail"
            />
            <div class="gallery-item-caption fs-sm fw-medium">
          ...
          <a
            href="./home-image/assets/img/about/gallery/05.jpg"
            class="gallery-item rounded-3"
            data-sub-html='<h6 class="fs-sm text-light">Efficient project management</h6>'
            target="_blank"
          >
            <img
            src= "{{ asset('integrations/home-image/assets/img/about/gallery/05.jpg') }}"
              alt="Gallery thumbnail"
            />
            <div class="gallery-item-caption fs-sm fw-medium">
    ...
    <section class="container pt-4 pb-5 py-lg-5">
      <h2
        class="h1 text-center pt-1 pt-md-3 pt-lg-4 pb-3 pb-md-4 mb-0 mb-lg-3"
      ...
      <div
        class="row row-cols-1 row-cols-sm-2 row-cols-md-3 row-cols-lg-4 g-2 g-lg-3 g-xl-4 pb-md-3 pb-lg-5"
        style="
          margin: 10px auto;
          padding-left: 25px;
          display: flex;
        ...
        <div class="cols-container-one font-card" style="width: 100%">
          ...
          <div class="col area-b" style="margin: 10px 20px">
            <div class="card h-100 bg-transparent border-0">
              <div
                class="bg-secondary easy-font rounded-3 w-auto lh-1 p-2 mt-4 ms-4 me-auto"
                style="text-align: center"
              >
                <i
                  class="fa-solid fa-kit-medical"
                  style="color: #8b5cf6; font-size: 2.5rem"
                ></i>
              </div>
              <div class="card-body">
    ...
    <section class="keep-card">
      ...
      <div class="container-card">
        ...
        <div class="box-card">
          ...
          <div class="w-full">
            <p>
              {{ substr(strip_tags($position->job_description), 0, 100) }}
            </p>
          </div>
          <div class="apps">
            @php
