...
@section('title', 'Requirement Report')
@section('content')
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card alljobPortals">
                <div class="card-header bg-primary">
                    <h4 class="card-title" style="color: #fff;">Requirement Report</h4>
                </div>
                <div class="card-body">
                    ...
                    <hr>
                    <div class="table-responsive card table-scroll" id="requirement_report_table" >
                       @include('master.404')
                    </div>
                </div>
            </div>
...
var res;
    function getReport() {
        ...
        $.ajax({
            type: 'POST',
            url: "{{ url('reports/requirement-report') }}",
            data: {
                _token: "{{ csrf_token() }}",
            ...
            success: function (response) {
                ...
                $('#requirement_report_table').empty();
                $("#requirement_report_table").html(response);
