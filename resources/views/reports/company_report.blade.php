        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card alljobPortals">
                <div class="card-header bg-primary">
                    <h4 class="card-title" style="color: #fff;">Company Report</h4>
                </div>
                <div class="card-body">
                    <div class="row col-md-12">
                        ...
                        <div class="col-md-3">
                            ...
                            <select name="status" id="status" class="form-control">
                                ...
                                <option value="dead">Dead Clients</option>
                            </select>
                        </div>
                    ...
                    <hr>
                    <div class="table-responsive card table-scroll" id="company_report_table" >
                       @include('master.404')
                    </div>
                </div>
            </div>
