<tbody>
    ...
    <tr>
        <td>{{ $key + 1 }}</td>
        <td><strong>{{ (!empty($interview->position) && !empty($interview->position->findClientGet)) ? $interview->position->findClientGet->name : '' }}</strong></td>
        <td><strong>{{ !empty($interview->position) ? $interview->position->position_name : '' }}</strong></td>
