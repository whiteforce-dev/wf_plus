                        ...
                        <li class="card myCard">
                            <div class="project-info">
                                ...
                                <div class="col-xl-8 my-2 col-lg-4 col-sm-6 row">
                                    ...
                                    <div class="col-auto">
                                        <p class="text-primary mb-1 font-dark">{{ ucwords($candidate->candidate->name) }} </p>
                                        <p class="text-primary mb-1 font-dark">{{ ucwords($candidate->candidate->email) }} </p>
                                        <p class="text-primary mb-1 font-dark">{{ ucwords($candidate->candidate->mobile) }} </p>
                                    </div>
