...
<div class="content-body">
        ...
        <div class="row">
            <div class="custom-tab-1 col-sm-6">
                <ul class="nav nav-tabs">
                    <li class="nav-item">
                        <a class="nav-link active" data-bs-toggle="tab" href="#position-section"><i
                                class="la la-briefcase me-2"></i> Positions</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#shared-position-section"
                            style="position: relative;"><i class="la la-share-square me-2"></i> Shared With Me
                            &nbsp;<span class="badge badge-danger badge-pill" style="position: absolute;
                                top: 7px;">{{ count($shareWithMePositions ?? []) }}</span></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-bs-toggle="tab" href="#shared-position-section-with-me"
                            style="position: relative;"><i class="la la-download me-2"></i> Shared By Me &nbsp;<span
                                class="badge badge-danger badge-pill" style="position: absolute;
            ...
            <div class="custom-tab-1 col-sm-5">
                {{-- <a href="{{ url('position/create') }}"><button class="btn btn-primary pull-right"><span
                            class="fa fa-plus"></span> Post Job</button></a> --}}
                            <div class="btn-group pull-right" role="group" aria-label="Basic example">
                                <a href="{{ url('position/create') }}"><button class="btn btn-primary "><span
                                    class="fa fa-plus"></span> Post Job</button></a>
                                    &nbsp;
                                    <a href="{{ url('refresh-cache/position') }}"><button class="btn btn-light"><span
                                        class="fa fa-refresh"></span> Refresh</button></a>
                              </div>
            </div>
        </div>
    ...
    <form action="{{ url('position') }}" method="get">
        <div class="input-group">
            <input type="search" value="{{ $position_name }}" class="form-control rounded"
                placeholder="Global Position Search" name="global_position_search" aria-label="Search"
...
<script>
    const cards = document.querySelectorAll("#customCard");
        ...
        function searchPosition(dis){
            ...
            $.get("{{ url('search-position') }}", {value}, function(response){
