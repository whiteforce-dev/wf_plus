...
@section('content')
    ...
    <style>
        ...
        .checkbox-input {
            ...
            &:focus+.checkbox-tile {
                border-color: #eb8153;
                box-shadow: 0 5px 10px rgba(#000, 0.1), 0 0 0 4px #eb8153;
            ...
            <div class="col-xl-7 col-lg-7">
                <div class="card">
                    <div class="card-header bg-primary">
                        ...
                        <div class="pull-right" style="padding: 2px 2px; background: white; border-radius: 15px;">
                            <style>
                                .switch {
                                    position: relative;
                        ...
                        <div class="basic-form">
                            <form action="{{ route('position.update',[$position->id]) }}" method="post" id='createPosition'>
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="single-select" name="countries" id="country"
                                            onchange="getState();">
                                    ...
                                    <div class="col-sm-3">
                                        <select class="single-select" name="states" id="state"
                                    ...
                                    <div class="col-sm-3">
                                        <select class="single-select" name="city" id="city">
            ...
            $("#createPosition").validate({
                ...
                messages: {
                    ...
                    postal_code: {
                        ...
                        maxlength: "Enter Maximum 6 digits",
                    },
            ...
            var a = new Promise((resolve, reject) => {
                fetch('http://139.59.14.185/jdparser/upload/api/', {
                    ...
                    .then(data => {
                        ...
                        var x = data;
                        console.log(x);
                        document.querySelector('#jd_json').value = JSON.stringify(x.data);
