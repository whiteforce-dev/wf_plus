        ...
        <div data-posname="GM Exports" class="divCsearch divrow" style="position: relative;">
            ...
            <div class="slide " align="left">
                <ul>
                    ...
                    <li><a href="{{ url('position-unhold', [$position->id]) }}" style="color:#e66025">Un-hold Position</a>
                    </li>
            ...
            <div class="parent c-position-div" style="position:relative;z-index: 3;width:90%;">
                ...
                <div class="d-flex justify-content-between card-header" style="z-index: 999;">
                    ...
                    <div class="d-flex" style="margin-top: 10px;" >
                        ...
                        <div class="client_logoDiv" id="client_logoDiv">
                            <img class="" id="client_logo_img" src="{{ url($img_data->image ?? '') }}"
                                alt="" />
                        </div>
