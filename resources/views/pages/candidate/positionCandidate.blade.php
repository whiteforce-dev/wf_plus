                ...
                <div class="container-fluid">
                            ...
                            <ul class="nav nav-tabs style-2">
                                <li class="nav-item">
                                    <a href="#navpills-1" class="nav-link active" data-bs-toggle="tab"
                                        aria-expanded="false">All Projects <span
                                            class="badge badge-pill shadow-primary badge-primary">154</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="#navpills-2" class="nav-link" data-bs-toggle="tab" aria-expanded="false">On
                                        Progress <span class="badge badge-pill badge-info shadow-info">2</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="#navpills-3" class="nav-link" data-bs-toggle="tab" aria-expanded="true">Pending
                                        <span class="badge badge-pill badge-warning shadow-warning">4</span></a>
                                </li>
                                <li class="nav-item">
                                    <a href="#navpills-4" class="nav-link" data-bs-toggle="tab" aria-expanded="true">Closed
                    ...
                    <div class="tab-content project-list-group" id="myTabContent">
                        <div class="tab-pane fade active show" id="navpills-1">
                            @foreach ($appliedCandidate as $appliedCandidates)
                                <div class="card">
                                    <div class="project-info">
                                        <div class="col-xl-3 my-2 col-lg-4 col-sm-6">
                                            <p class="text-primary mb-1">#EP-wf00{{ $appliedCandidates->id }}</p>
                                            <h5 class="title font-w600 mb-2"><a href="post-details.html"
                                                    class="text-black">{{ $appliedCandidates->name }}</a></h5>
                                            <div class="text-dark"><i class="far fa-calendar me-3"
                                                    aria-hidden="true"></i>{{ \Carbon\Carbon::parse($appliedCandidates->created_at)->format('j F, Y') }}
                                            </div>
                                        </div>
                                        <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                <div class="project-media">
                                                    <img src="{{ url('$appliedCandidates->image') }}" alt="">
                                                </div>
                                                <div class="ms-2">
                                                    <span>{{ $appliedCandidates->mobile }}</span>
                                                    <h5 class="mb-0 pt-1 font-w50 text-black">
                                                        {{ $appliedCandidates->current_title }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-2 my-2 col-lg-4 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    <span>{{ $appliedCandidates->current_location }}</span>
                                                    <h5 class="mb-0 pt-1 font-w500 text-black">
                                                        {{ $appliedCandidates->gender }}</h5>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-xl-3 my-2 col-lg-6 col-sm-6">
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="ms-2">
                                                    <span>Job Title</span>
                                                    <h5 class="mb-0 pt-1 font-w500 text-black">
                                                        {{ $appliedCandidates->job_title }}</h5>
                                                </div>
                                            </div>
                                        </div>
