...
@section('title', 'Update Team Target')
@section('content')
<style>
    th {
        ...
        <div class="col-xl-12 col-lg-12">
            <div class="card">
                <div class="card-header bg-primary">
                    <h4 class="card-title" style="color:white">Edit <b style="color:rgb(241, 231, 84)">
                        ...
                        <div class="main-content">
                            ...
                            <div class="row">
                                ...
                                <div class="mydiv col-sm-12" style="background: white">
                                    ...
                                    <form action="{{ url('update-user-target') }}" method="POST">
                                        @csrf
                                        <table class="table table-striped">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="">Complete</th>
                                                    <th style="">Left</th>
                                                    @if (Auth::user()->role == 'admin')
                                                    <th style="">Assign Target</th>
                                                    @endif
                                                </tr>
                                            </thead>
                                            ...
                                            <tbody>
                                                ...
                                                @include('pages.target.childrow', ['node' => $team, 'level' => 0])
                                                ...
                                                <tr class='tar'>
                                                    ...
                                                    <td style="width: 160px;"><b>Month Total Target</b>
                                                    ...
                                                    <td style="width: 155px;text-align:center"><b>Total Left</b>
                                                        <hr> <button type="button"
                                        ...
                                        @if ($buttonShowStatus)
                                        <button type="submit" class="btn btn-outline-primary btn-lg btn-block">Update

                                            <b>{{ $team['name'] }}'s</b> Team Target</button>
                                        @else
                                        <button type="submit" class="btn btn-outline-primary btn-lg btn-block">Update
                                            <b>{{ $team['name'] }}'s</b> Team Target </button>
