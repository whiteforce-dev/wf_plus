<div class="form-group">
    <label class="pay">Category Function </label>
    <select name="category_function_id" class="list-dt form-control js-example" id="category_function_id" onchange="getCategoryRole(this.value);">
